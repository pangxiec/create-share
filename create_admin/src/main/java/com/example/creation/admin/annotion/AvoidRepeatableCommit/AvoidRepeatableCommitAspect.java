package com.example.creation.admin.annotion.AvoidRepeatableCommit;
...
public class AvoidRepeatableCommitAspect {
     ...
     * @param point
     */
    @Around("@annotation(com.example.creation.admin.annotion.AvoidRepeatableCommit.AvoidRepeatableCommit)")
