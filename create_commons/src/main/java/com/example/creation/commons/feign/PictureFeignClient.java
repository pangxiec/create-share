...
import com.example.creation.commons.fallback.PictureFeignFallback;
 ...
 *
 */
@FeignClient(name = "create-picture", configuration = FeignConfiguration.class, fallback = PictureFeignFallback.class)
