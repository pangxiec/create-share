...
<article>
    <h1 class="t_nav"><a href="/" class="n1">网站首页</a><a href="/" class="n2">${blog.articleSort.sortName}</a></h1>
    <div class="infosbox">
        <div class="newsview">
            ...
            <div class="bloginfo">
                <ul>
                    ...
                    <#if blog.articleSort??>
                        <li class="lmname"><a href="/">${blog.articleSort.sortName}</a></li>
                    </#if>
    ...
    <div class="sidebar">
        ...
        <div class="guanzhu" id="gd">
            ...
            <ul>
                <li class="sina"><a href="/" target="_blank"><span>新浪微博</span>杨青文章</a></li>
                <li class="tencent"><a href="/" target="_blank"><span>腾讯微博</span>杨青文章</a></li>
...
<footer>
    <p>Design by <a href="http://www.yangqq.com" target="_blank">杨青个人文章</a> <a href="/">蜀ICP备11002373号-1</a></p>
</footer>
