package com.example.creation.picture.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.example.creation.commons.entity.File;
import com.example.creation.commons.entity.FileSort;
import com.example.creation.commons.entity.SystemConfig;
import com.example.creation.picture.global.MessageConf;
import com.example.creation.picture.global.SQLConf;
import com.example.creation.picture.global.SysConf;
import com.example.creation.picture.mapper.FileMapper;
import com.example.creation.picture.service.*;
import com.example.creation.picture.util.AboutFileUtil;
import com.example.creation.picture.util.FeignUtil;
...
import com.example.creation.base.enums.EFilePriority;
import com.example.creation.base.enums.EOpenStatus;
...
public class FileServiceImpl extends SuperServiceImpl<FileMapper, File> implements FileService {
    ...
    public String getPicture(String fileIds, String code) {
        ...
        if (StringUtils.isEmpty(fileIds)) {
            ...
            QueryWrapper<com.example.creation.commons.entity.File> queryWrapper = new QueryWrapper<>();
            queryWrapper.in(SQLConf.UID, changeStringToString);
            List<com.example.creation.commons.entity.File> fileList = fileService.list(queryWrapper);
            if (fileList.size() > 0) {
                for (com.example.creation.commons.entity.File file : fileList) {
                    if (file != null) {
    ...
    public String uploadPictureByUrl(FileVO fileVO) {
        ...
        List<com.example.creation.commons.entity.File> lists = new ArrayList<>();
        //文件上传
        if (urlList != null && urlList.size() > 0) {
            for (String itemUrl : urlList) {
                ...
                com.example.creation.commons.entity.File file = new com.example.creation.commons.entity.File();
                file.setCreateTime(new Date(System.currentTimeMillis()));
                file.setFileSortUid(fileSort.getUid());
