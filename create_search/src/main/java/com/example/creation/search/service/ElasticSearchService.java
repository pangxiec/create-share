package com.example.creation.search.service;
...
import com.example.creation.search.mapper.HighlightResultHelper;
...
public class ElasticSearchService {
    ...
    public ESBlogIndex buidBlog(Article eblog) {
        ...
        if (eblog.getArticleSort() != null) {
            blog.setBlogSortName(eblog.getArticleSort().getSortName());
            blog.setBlogSortUid(eblog.getArticleSortUid());
        }
