package com.example.creation.base.global;
...
public class BaseMessageConf {
    ...
    public static final String BLOG_NO_OPEN_COMMENTS = "本文章未开启评论功能";
    ...
    public static final String BLOG_UNDER_THIS_SORT = "该分类下还有文章！";
    ...
    public static final String BLOG_UNDER_THIS_TAG = "该标签下还有文章！";
    ...
    public static final String PLEASE_CONFIGURE_BLOG_COUNT = "请先到参数配置，配置文章显示数量";
    ...
    public static final String PLEASE_CONFIGURE_SYSTEM_PARAMS = "请先到后台参数配置，配置文章相关参数";
