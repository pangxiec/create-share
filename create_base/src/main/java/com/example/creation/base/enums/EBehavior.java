package com.example.creation.base.enums;
...
public enum EBehavior {
    ...
    BLOG_SORT("点击文章分类", "blog_sort"),
    BLOG_CONTNET("点击文章", "blog_content"),
    ...
    VISIT_CLASSIFY("点击文章分类", "visit_classify"),
